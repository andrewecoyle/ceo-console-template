...
1. **Read context:**
   - `executive-team/product-lead/knowledge-base.md` - Product patterns
   - `executive-team/product-lead/current-focus.md` - Current roadmap
   - `shared-memory/ceo-preferences.md` - CEO's preferences (including Fidelity model)
   - `shared-memory/company-strategy.md` - Strategic alignment
...
1. **Update Product Lead's knowledge:**
   - Write to `executive-team/product-lead/current-focus.md`
   - Log feature as shipped
   - Add any learnings to `executive-team/product-lead/knowledge-base.md`

2. **Update shared memory if applicable:**
   - If CEO revealed new preferences → `shared-memory/ceo-preferences.md`
   - If this affects strategy → `shared-memory/company-strategy.md`

3. **Present final summary to CEO:**
